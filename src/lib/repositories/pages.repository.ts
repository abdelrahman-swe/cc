  ...
  layout: [
    {
      ...
      sectionTag: "شركاء النجاح",
      selectionMode: "all",
    },
    {
      blockType: "services-block",
      sectionTag: "خدماتنا",
      title: "حلول تقنية متكاملة تسرع نمو أعمالك",
      selectionMode: "all",
    },
    {
      blockType: "who-we-are-block",
      sectionTag: "من نحن",
      title: "نبني المستقبل الرقمي بشغف وخبرة استثنائية",
    },
    {
      blockType: "featured-work-block",
      sectionTag: "أعمالنا الرقمية",
      title: "قصص نجاح تعكس جودة التنفيذ والأثر",
      selectionMode: "featured",
    },
    {
      blockType: "methodology-block",
      sectionTag: "منهجية العمل",
      title: "خطوات واضحة تضمن نجاح مشروعك من الفكرة إلى الإطلاق",
    },
    {
      blockType: "blog-block",
      sectionTag: "المدونة التقنية",
      title: "مقالات ورؤى حول أحدث التقنيات والتحول الرقمي",
      selectionMode: "latest",
    },
    {
      blockType: "final-cta-block",
      headline: "هل أنت جاهز لتحويل فكرتك إلى واقع رقمي؟",
    },
  ],
  seo: {
    metaTitle: "CodeClouders - شركة تطوير برمجيات وسحابة متقدمة",
    metaDescription:
      "حلول رقمية وأنظمة سحابية وتطبيقات جوال عالية الأداء للمؤسسات والشركات.",
  },
  settings: {
...
export async function getPageBySlug(
  ...
  try {
    ...
    console.warn(
      `Payload page query for '${slug}' fallback to defaults:`,
      error,
    );
  }
